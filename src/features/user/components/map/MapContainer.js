...
import {
  setMarkerToList,
  setMarkersAction,
} from "features/user/modules/actions";
...
const MapContainer = () => {
  ...
  const [[user, modal], actions] = useRedux(["user", "modal"], {
    openModal,
    setMarkerToList,
    setMarkersAction,
  });
  ...
  const removeMarkerWithoutTitleByCloseModal = useCallback(() => {
    if (wasMadalOpen) {
      ...
      actions.setMarkersAction(profiledMarkers);
    }
  });
  ...
  const addMarker = useCallback(
    event => {
      ...
      actions.setMarkerToList(newMarker);
      actions.openModal({
...
// import { withScriptjs, withGoogleMap } from "react-google-maps";
// import { openModal } from "components/modal/modules/actions";
// import { setMarkerToList, setMarkersAction } from "features/user/modules/actions";
// import MarkerInfoForm from "../marker-info-form";
// import Map from "./Map";
//
// const MapContainer = () => {
...
//
//   const [translate] = useTranslate();
//   const [[user, modal], actions] = useRedux(["user", "modal"], { openModal, setMarkerToList, setMarkersAction });
//
//   const wasMadalOpen = usePrevious(modal.isOpen);
//
//   const [center, setCenter] = useState({ lat: 0, lng: 0 });
